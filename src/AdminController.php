...
class AdminController {
    ...
    public function listPayments(): void {
        $this->requireAdmin();
        $payments = $this->db->fetchAll('SELECT u.id, u.email, u.plan_status, u.has_paid, u.created_at, u.paddle_subscription_id, u.fastspring_subscription_id, u.cancel_requested_at, u.cancel_method, u.next_billed_at, u.pending_plan_change, u.refund_requested_at FROM users u WHERE u.has_paid = 1');
