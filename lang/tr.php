...
return [
    ...
    'auth.forgot_password_heading' => 'Şifreni sıfırla',
    'auth.forgot_password_instructions' => 'E-posta adresini gir, sana şifreni sıfırlaman için bir bağlantı gönderelim.',
    'auth.send_reset_link' => 'Sıfırlama bağlantısı gönder',
    'auth.reset_email_sent' => 'Bu e-posta ile bir hesap varsa, şifre sıfırlama bağlantısını gönderdik.',
    'auth.reset_password_heading' => 'Yeni bir şifre belirle',
    ...
    'chat.trial_remaining' => 'Ücretsiz Deneme: %d / 15 mesaj kaldı',
    'chat.send' => 'Gönder',
    'chat.you' => 'Sen',
    'chat.kai' => 'Kai',
    'chat.today' => 'Bugün',
    ...
    'chat.error_rate_limited' => 'Yapay zeka öğretmenimiz şu anda biraz yoğun. Lütfen birazdan tekrar deneyin.',
    ...
    'chat.study_session' => 'Keşif Hazinesi',
    'chat.topic_label' => 'Konu',
    'chat.enter_hint' => 'Gönder için Enter · Yeni satır için Shift+Enter',
    'chat.retry_send' => 'Yeniden Dene',
    'chat.send_failed' => 'Gönderilemedi',
    'chat.scroll_to_latest' => 'Son mesaja git',
    ...
    'fc.all' => 'Tümü',
    'fc.category_body' => 'Vücut',
    'fc.category_nature' => 'Doğa',
    'fc.category_work' => 'İş',
    'fc.category_numbers' => 'Sayılar',
    'fc.category_colors' => 'Renkler',
    'fc.category_actions' => 'Eylemler',
    'fc.category_describing' => 'Sıfatlar',
    'fc.category_time' => 'Zaman',
    'fc.category_hsk' => 'HSK',
    'fc.packs_title' => 'Kelime paketleri',
    'fc.packs_hint' => 'Seviye seviye daha fazla kelime ekleyin.',
    'fc.pack_add' => 'Ekle',
    'fc.pack_added' => 'Eklendi',
    'fc.pack_words' => '%d kelime',
    'fc.pack_error' => 'Kelimeler eklenemedi. Lütfen tekrar deneyin.',
    ...
    'fc.percent_learned' => '%%%d\'si Öğrenildi',
    ...
    'pricing.trial_active_desc' => 'Sistemi 15 ücretsiz mesajla deneyebilirsiniz. Kalan mesaj: <strong>%d</strong>',
    'pricing.trial_prompt_title' => 'Kaydolun ve Şimdi Deneyin',
    'pricing.trial_prompt_desc' => 'Sistemi keşfetmek için kredi kartı gerektirmeyen tamamen ücretsiz 15 mesajlık denemeye başlayın.',
    'pricing.go_to_chat' => 'Sohbete Git',
    'pricing.start_trial' => 'Ücretsiz Dene',
    'pricing.toggle_monthly' => 'Aylık',
    'pricing.toggle_yearly' => 'Yıllık',
    'pricing.toggle_save_badge' => '%17 tasarruf',
    'pricing.starter_title' => 'Başlangıç Planı',
    'pricing.starter_monthly' => '$15<span class="text-xl text-outline">/ay</span>',
    'pricing.starter_yearly' => '$150<span class="text-xl text-outline">/yıl</span>',
    ...
    'pricing.pro_yearly' => '$500<span class="text-xl text-outline">/yıl</span>',
    ...
    'pricing.premium_yearly' => '$1500<span class="text-xl text-outline">/yıl</span>',
    'pricing.premium_desc' => 'Güç kullanıcıları için her şey dahil',
    'pricing.premium_feature_1' => 'Ayda 1500 mesaj',
    ...
    'pricing.renews_on' => '%s tarihinde yenilenecek',
    'pricing.change_pending_notice' => '%1$s planına %2$s tarihinde geçilecek — o zamana kadar mevcut planınız devam ediyor',
    'pricing.change_pending_error' => 'Zaten planlanmış bir plan değişikliğiniz var. Yeni bir tane planlamadan önce aboneliğinizi devam ettirip mevcut olanı iptal edin.',
    'pricing.change_deferred_title' => 'Plan değişikliği planlandı',
    'pricing.change_deferred_body' => 'Bir sonraki fatura tarihinizde %s planına geçeceksiniz. O zamana kadar mevcut planınız ve kotanız devam eder — standart uygulamaya uygun olarak fark için iade yapılmaz.',
    'pricing.request_refund' => 'İade Talep Et',
    'pricing.refund_requested_note' => 'İade talep edildi — ekibimiz e-posta ile dönüş yapacak',
    'pricing.confirm_refund_title' => 'İade talep etmek istiyor musunuz?',
    'pricing.confirm_refund_body' => 'Talebinizi iade politikamıza göre değerlendirip e-posta ile dönüş yapacağız. Bu, aboneliğinizi iptal etmez.',
    'pricing.refund_success' => 'İade talebiniz ekibimize iletildi. Kısa süre içinde e-posta ile dönüş yapacağız.',
    'pricing.refund_error' => 'İade talebinizi gönderemedik. Lütfen tekrar deneyin ya da doğrudan info@jumplearner.com adresine e-posta atın.',
    'pricing.confirm_change' => 'Bu plana geçmek istiyor musunuz? Fiyat farkı otomatik olarak orantılı şekilde hesaplanır.',
    'pricing.manual_change_required' => 'Planınızı henüz otomatik olarak değiştiremiyoruz. Lütfen info@jumplearner.com adresinden bize ulaşın, sizin için yapalım.',
    ...
    'admin.search_email' => 'E-posta ile ara',
    'admin.search' => 'Ara',
    'admin.no_results' => 'Sonuç yok.',
    'admin.prev_page' => 'Önceki',
    'admin.next_page' => 'Sonraki',
    'admin.page_label' => 'Sayfa',
    ...
    'admin.revenue' => 'Tahmini Aylık Gelir (USD)',
    'admin.csv_download' => 'CSV İndir',
    'admin.user_list' => 'Kullanıcı Listesi',
    'admin.admin_list' => 'Yönetici Listesi',
    'admin.role_col' => 'Rol',
    'admin.role_full' => 'Tam yetki',
    'admin.role_viewer' => 'Görüntüleyici (salt okunur)',
    'admin.remove' => 'Kaldır',
    'admin.confirm_remove' => 'Bu admin kaldırılsın mı? Erişimi hemen kesilir.',
    'admin.add_admin' => 'Admin ekle',
    'admin.id' => 'ID',
    ...
    'admin.starter_yearly_price_id' => 'Başlangıç Planı Yıllık Fiyat Kimliği',
    'admin.pro_yearly_price_id' => 'Pro Planı Yıllık Fiyat Kimliği',
    'admin.premium_yearly_price_id' => 'Premium Planı Yıllık Fiyat Kimliği',
