...
<main
  ...
  <div class="relative z-10 max-w-2xl">
    <div data-m="rise" data-m-at="0"
      ...
      <span class="w-2 h-2 bg-primary rounded-full animate-pulse m-still"></span>
      <?= __('home.badge') ?>
    </div>
    ...
    <p data-m="rise" data-m-at=".35" class="font-headline-md text-headline-md text-on-surface mb-2">
      <?= __('home.heading') ?>
    </p>

    <p data-m="rise" data-m-at=".45" class="text-body-lg text-on-surface-variant mb-8">
      <?= __('home.subtitle') ?>
    </p>
    ...
    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
      <a data-m="rise" data-m-at=".6" href="<?= $isLoggedIn ? '?page=chat' : '?page=register' ?>"
      ...
      <a data-m="rise" data-m-at=".68" href="?page=blog"
